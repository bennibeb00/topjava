...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        System.out.println(dateAndCalories);
        List<UserMealWithExcess> userMealWithExcesses = new ArrayList<>();
        for (UserMeal userMeal : meals) {
            if (TimeUtil.isBetweenHalfOpen(userMeal.getDateTime().toLocalTime(), startTime, endTime)) {
                sumOfCalories += dateAndCalories.get(userMeal.getDateTime().toLocalTime());
                userMealWithExcesses.add(new UserMealWithExcess(userMeal.getDateTime(), userMeal.getDescription(),
                        userMeal.getCalories(), sumOfCalories > caloriesPerDay));
            }
        }
    ...
    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        AtomicInteger sumOfCalories = new AtomicInteger();
        ...
        return meals
                ...
                .map(um -> {
                    sumOfCalories.addAndGet(map.get(um.getDateTime().toLocalTime()));
                    return new UserMealWithExcess(um.getDateTime(), um.getDescription(), um.getCalories(), sumOfCalories.get() > caloriesPerDay);
